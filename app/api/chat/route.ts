...
export async function POST(req: Request) {
  try {
    ...
    console.log("Resultado de streamText:", result) // Log: Resultado de la llamada a OpenAI

    // Placeholder response for debugging
    return new Response("Resultado recibido. Ver logs para más detalles.", {
      headers: {
